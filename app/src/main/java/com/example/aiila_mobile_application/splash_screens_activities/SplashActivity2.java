...
public class SplashActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.splashactivity2_main);
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent btn_next=new Intent(getApplicationContext(), SplashActivity3.class);
...
//                    public void run() {
//
//                        i = new Intent(SplashActivity2.this, SplashActivity2.class);
//                        startActivity(i);
//                        finish();
//
//                    }
